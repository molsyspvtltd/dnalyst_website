...
const products = [
  {
    id: 1,
    name: "slimKr",
    desc: "Holistic personalized weight management program: tailored Diet, nutrition and genetics-based intervention. Lose weight the healthy way.",
    image: slimKr,
    link: "/product_detail?product=slimKr" // Use query parameter for product
  },
  {
    id: 2,
    name: "fitKr",
    ...
    image: fitKr,
    link: "/product_detail?product=fitKr" // Use query parameter for product
  },
  {
    id: 3,
    name: "fitKr Pro",
    ...
    image: fitKrPro,
    link: "/product_detail?product=fitKrPro" // Use query parameter for product
  },
  {
    id: 4,
    name: "kinKr",
    ...
    image: kinKr,
    link: "/product_detail?product=kinKr" // Use query parameter for product
  },
  {
    id: 5,
    name: "herKr",
    desc: "Coming Soon !!!",
    image: herKr,
    link: "/product_detail?product=herKr" // Use query parameter for product
  },
  {
    id: 6,
    name: "gutKr",
    ...
    image: gutKr,
    link: "/product_detail?product=gutKr" // Use query parameter for product
  },
  {
    id: 7,
    name: "gutKr Pro",
    desc: "Coming Soon !!!",
    image: gutKrPro,
    link: "/product_detail?product=gutKrPro" // Use query parameter for product
  },
];
        ...
        >
          ...
          <div className="grid gap-8 sm:grid-cols-2 md:grid-cols-3">
            {products.map((product) => (
              <Link key={product.id} to={product.link}> {/* Wrap product card with Link */}
                <ProductCard {...product} />
              </Link>
            ))}
          </div>
